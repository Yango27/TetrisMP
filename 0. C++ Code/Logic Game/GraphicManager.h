...
typedef enum 
{
    ...
    GRAFIC_QUADRAT_VERD,
    GRAFIC_QUADRAT_GROC_TRANSPARENT,
    GRAFIC_QUADRAT_BLAUCEL_TRANSPARENT,
    GRAFIC_QUADRAT_MAGENTA_TRANSPARENT,
    GRAFIC_QUADRAT_TARONJA_TRANSPARENT,
    GRAFIC_QUADRAT_BLAUFOSC_TRANSPARENT,
    GRAFIC_QUADRAT_VERMELL_TRANSPARENT,
    GRAFIC_QUADRAT_VERD_TRANSPARENT,
    GRAFIC_NUM_MAX
} IMAGE_NAME;
